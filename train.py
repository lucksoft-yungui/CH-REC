...
def main():
    ...
    val_dataset = get_dataset(config)(config, phase='val')
    ...
    test_dataset = get_dataset(config)(config, phase='test')
    ...
    for epoch in range(last_epoch, config.TRAIN.END_EPOCH):
        ...
        function.train(config, train_loader, train_dataset, val_loader, val_dataset, converter, model,
                       criterion, optimizer, device, epoch, writer_dict, output_dict)
        lr_scheduler.step()

        acc = function.validate(config, test_loader, test_dataset, converter,
        ...
        print("best acc is:", config.TRAIN.BEST_ACC)
        # save checkpoint
